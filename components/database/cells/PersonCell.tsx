...
export function PersonCell({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div className="absolute left-0 top-full z-50 mt-1 min-w-48 rounded-lg border border-zinc-200 bg-white py-1 shadow-lg dark:border-zinc-700 dark:bg-zinc-900">
          {users.length === 0 ? (
