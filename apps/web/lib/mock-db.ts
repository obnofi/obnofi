  ...
  return {
    pages: new Map([
      ["page-1", {
        ...
        type: "document", icon: null, coverImage: null, parentId: null, workspaceId: "ws-1",
        createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
        isPublic: false, shareId: null, sharePassword: null,
      }],
      ["page-2", {
        id: "page-2", title: "Project Clearing", content: null, type: "canvas", icon: null, coverImage: null,
      ...
      ["page-3", {
        id: "page-3", title: "Tasks", content: null, type: "database", icon: null, coverImage: null,
      ...
      ["page-4", {
        ...
        type: "document", icon: null, coverImage: null, parentId: "page-1", workspaceId: "ws-1",
      ...
      // Database rows
      ["row-1", {
        id: "row-1", title: "Homepage Redesign", content: null, type: "document", icon: null, coverImage: null,
      ...
      ["row-2", {
        id: "row-2", title: "API Documentation", content: null, type: "document", icon: null, coverImage: null,
        parentId: "page-3", workspaceId: "ws-1", databaseId: "db-1", parentDatabaseId: "db-1",
        createdAt: new Date("2026-04-12").toISOString(), updatedAt: new Date("2026-04-12").toISOString(),
        isPublic: false, shareId: null, sharePassword: null,
      }],
      ["row-3", {
        id: "row-3", title: "User Research", content: null, type: "document", icon: null, coverImage: null,
        parentId: "page-3", workspaceId: "ws-1", databaseId: "db-1", parentDatabaseId: "db-1",
        createdAt: new Date("2026-04-14").toISOString(), updatedAt: new Date("2026-04-14").toISOString(),
        isPublic: false, shareId: null, sharePassword: null,
      }],
      ["row-4", {
        id: "row-4", title: "Backend Migration", content: null, type: "document", icon: null, coverImage: null,
        parentId: "page-3", workspaceId: "ws-1", databaseId: "db-1", parentDatabaseId: "db-1",
        createdAt: new Date("2026-04-06").toISOString(), updatedAt: new Date("2026-04-06").toISOString(),
        isPublic: false, shareId: null, sharePassword: null,
      }],
      ["row-5", {
        id: "row-5", title: "Onboarding Flow", content: null, type: "document", icon: null, coverImage: null,
        parentId: "page-3", workspaceId: "ws-1", databaseId: "db-1", parentDatabaseId: "db-1",
